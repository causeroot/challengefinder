function Site_Classify_v3(eval_file,eval_output_file,search_string_out_file)
...
fprintf('\n')
fprintf('\nProgram paused. Press enter to compile the dictionary.\n\n');
pause;
dictionary_features_file = 'dictionary_features_file.mat';
dictionary_class_file = 'dictionary_class_file.mat';
dictionary_words_file = 'dictionary_words_file.mat';
dictionary_pairs_file = 'dictionary_pairs_file.mat';
...
prmpt = yes_or_no('Do you want to generate a new Dicitonary, or use the previous one?');
tic
if prmpt == 0
